...
public final class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if(config.function_CustomeRole()){getServer().getPluginManager().registerEvents(new chatWithCustomRole(this),this);}
    ...
    public static class config{
        ...
        static String AI_name(){return Objects.requireNonNull(configs.getString("chat_AI_name"));}
        static String AI_token(){return  Objects.requireNonNull(configs.getString("chat_token"));}

        static String CustomeRoleName(){return Objects.requireNonNull(configs.getString("CustomRole_name"));}
        static String CustomRole_prompt(){return Objects.requireNonNull(configs.getString("CustomRole_prompt"));}
        static int CustomRole_memory_time(){return Integer.parseInt(Objects.requireNonNull(configs.getString("CustomRole_memory_time")));}
        ...
        // 功能开启管理
        static boolean function_CustomeRole(){return Objects.equals(configs.getString("chat_with_CustomRole"), "true");}
